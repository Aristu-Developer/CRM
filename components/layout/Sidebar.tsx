...
// Keep in sync with lib/admin.ts — client components can't import server helpers.
const SUPER_ADMIN_EMAIL = "sangharsh.thecreator@gmail.com";
...
export function Sidebar({ open = false, onClose }: SidebarProps) {
  ...
  return (
    <aside className={cn(
      "print:hidden fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 flex flex-col z-50",
      ...
      <div className="border-t border-gray-200 py-3 px-3 space-y-0.5">
        ...
        {/* Platform Admin link — super admin only */}
        {isSuperAdmin && (
          <Link
            href="/admin"
            className={cn(
